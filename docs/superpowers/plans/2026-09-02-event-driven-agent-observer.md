...
- Modify: `src-tauri/src/sources/mod.rs` — export the observer implementation name.
- Modify: `src-tauri/src/lib.rs` — start and shut down the two-lane live runtime.
...
- `TraceSignalResult` contains `summary: UsageSummary` and a transition with `Started { provider }`, `Stopped { provider, remaining_runs }`, or `Ignored`.
...
- [ ] **Step 2: Run the focused tests and confirm the new seam fails.**
...
- [ ] **Step 3: Implement the smallest decoupled runtime state.**
...
**Interfaces:**
- `CollectionCommand` is internal and contains `Activate(Provider)`, `Changed(Provider)`, `WatchUnavailable(Provider)`, `ConfigurationChanged`, `FinalFlush(Provider)`, and `Shutdown`.
...
- [ ] **Step 1: Write failing isolation and lifecycle scheduling tests.**
...
- [ ] **Step 3: Implement lifecycle-aware collection commands and scheduler.**
...
- [ ] **Step 4: Implement the non-blocking control loop.**
...
- [ ] **Step 5: Run focused live-loop tests.**
...
- [ ] **Step 6: Commit the split runtime.**
...
- [ ] **Step 1: Write failing dynamic observer tests.**
...
- [ ] **Step 2: Run the observer tests and confirm the current startup watcher fails the lifecycle expectation.**
...
- [ ] **Step 3: Implement provider-scoped observer ownership.**
...
- [ ] **Step 4: Connect activation/Stop leases to observer start/stop.**
...
- [ ] **Step 5: Run focused observer and live-loop tests.**
...
- [ ] **Step 1: Write failing pipe retry and startup ownership tests.**
...
- [ ] **Step 2: Run focused trace tests and confirm the retry seam is absent.**
...
- [ ] **Step 3: Implement bounded send retry.**
...
- [ ] **Step 4: Wire two-lane startup and shutdown.**
...
- [ ] **Step 5: Run focused cross-boundary tests.**
...
- [ ] **Step 6: Commit hook/runtime wiring.**
...
- [ ] **Step 2: Run collection, database, provider, and privacy regressions.**
...
- [ ] **Step 4: Run the integrated debug build.**
...
- [ ] **Step 6: Review the final diff and commit the verification result.**
